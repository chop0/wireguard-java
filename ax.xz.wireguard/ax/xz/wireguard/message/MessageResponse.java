 ...
 * }
 */
public final class MessageResponse extends PooledPacket implements Message {
	...
	public static MessageResponse create(int localIndex, int remoteIndex, NoisePublicKey localEphemeral, byte[] encryptedEmpty, NoisePublicKey initiatorKey) throws InterruptedException {
