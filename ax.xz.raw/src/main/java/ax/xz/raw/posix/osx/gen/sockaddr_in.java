...
public class sockaddr_in {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        osx_tun_h.C_CHAR.withName("sin_len"),
        osx_tun_h.C_CHAR.withName("sin_family"),
        osx_tun_h.C_SHORT.withName("sin_port"),
        in_addr.layout().withName("sin_addr"),
        MemoryLayout.sequenceLayout(8, osx_tun_h.C_CHAR).withName("sin_zero")
