...
public class in6_addr {
    ...
    public static class __u6_addr {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(16, osx_tun_h.C_CHAR).withName("__u6_addr8"),
            MemoryLayout.sequenceLayout(8, osx_tun_h.C_SHORT).withName("__u6_addr16"),
            MemoryLayout.sequenceLayout(4, osx_tun_h.C_INT).withName("__u6_addr32")
        ).withName("$anon$153:2");
